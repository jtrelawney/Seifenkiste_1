...
int main(int argc, char *argv[])
{
    ...
    //create a display window which is used in the loop to display the image which was received via TCP
	...
	while(1){
        ...
        // the frame is filled in the tcp server, the global variable is defined in the defs.h
        printf("display image\n");
        imshow("rpi_camera", global_test_frame);
        waitKey(20);
