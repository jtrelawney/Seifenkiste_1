...
#include <limits.h> // for min max etc
...
// lists the buffer content as char separated with a comma delimiter
void list_buffer_content(char *buffer, int length);
// prints the buffer content as a table with different formats, allows more detailed debugging
